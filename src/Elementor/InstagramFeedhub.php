...
class InstagramFeedhub extends Widget_Base
{
	...
	protected function render()
	{
		...
		?>
<div class="wil-instagram-shopify" data-id="<?php echo $dataId; ?>"
    style="padding: 10px; background: #4CAF50; color: white;text-align: center; border-radius: 4px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
    ...
    <span style="margin-left: 10px;">InstagramFeed
        <?php echo $dataId ? "(id: {$dataId})" : "" ; ?></span>
</div>
